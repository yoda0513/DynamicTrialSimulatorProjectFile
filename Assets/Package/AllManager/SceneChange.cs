...
static class SceneChange
{
    ...
    public static void resetScene()
    {
        ...
        {
            Debug.Log($"{i.name}をアンロードしました");
            SceneManager.UnloadSceneAsync(i);
        }

        AddLoadScene("Animation");
        AddLoadScene("Histogram");
        AddLoadScene("GraphPlot");
    }

    //シーンを読み込む
    public static void AddLoadScene(string sceneName, bool async = true)
    {
